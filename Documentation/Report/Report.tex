...
\subsection{Density}
(Mention to variations on density - global and local. Give references)
...
Details surrounding how exactly these thresholds are set can be found in \citet{Delany2005}, but roughly, values are chosen on a per-dataset basis through experimentation. The experimentation, for binary classification give, maximize the correct classifications, while keeping the false-positives zero.
