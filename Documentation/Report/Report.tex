...
%TODO A more explicit presentation of a) Case-Based classification using kNN and b) Pool-Based Sampling and other assumptions that you made might be useful here, along with their descriptions. Then, section 1.4 can explicity contrast variations with 1.3
...
%TODO Not really the right kind of <?>. Instead give an overview of subsequent chapters. "In chapter 2, we will . . . Then in chapter 3 . . ."
...
%TODO Outline Strategies (I was expecting this chapter to review selection strategies (which it does in section 2.2.3 and 2.2.4). I'm not sure 2.2.1 and 2.2.2 belong in this chapter Admittedly, it is uncomfortable shoe-horning them into chapter 4.)
